...
export default function EditSpecializationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const response = await postMethod(`/specializations/update/${id}`, formDataToSend)
    setLoading(false)
      ...
      <Form onSubmit={handleSubmit} className='mt-5 '>
        <div className='row w-100'>
          ...
          <Form.Group className='my-5' style={{ width: '45%' }} controlId='name'>
            ...
            {iconPreview && (
              <img src={iconPreview} alt='icon' width={100} height={100} />
            )}
          </Form.Group>
