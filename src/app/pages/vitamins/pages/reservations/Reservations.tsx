  ...
  return (
    <Routes>
      <Route element={<Outlet />}>
        ...
        <Route path='add' element={<ComponentTableWithTitle title={t('Add Vitamin Reservasion')} component={<AddReservationPage />} />} />
        <Route path='edit/:id' element={<ComponentTableWithTitle title={t('Edit Vitamin Reservation')} component={<EditReservationPage />} />} />
      </Route>
    </Routes>
  );
}
