...
export default function AddVisitANursePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const response = await postMethod(`/nursing_tasks`, formDataToSend)
    setLoading(false)
      ...
      <Form onSubmit={handleSubmit} className='mt-5'>
        <div className='row w-100'>
          ...
          <Form.Group className='my-5' style={{width: '45%'}} controlId='description'>
            ...
            <Form.Control as={'textarea'} placeholder={t('Enter Description')} value={formData.description} onChange={handleChange} />
          </Form.Group>
