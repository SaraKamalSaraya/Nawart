...
export default function MedicalCentersPage() {
  return (
    <Routes>
      ...
      <Route path='/' element={<ComponentTableWithTitle title='Medical Centers Nursing' component={<MedicalCenterTable />} />} />
        <Route path='add' element={<ComponentTableWithTitle title='Add Medical Center Nursing' component={<AddMedicalCenter />} />} />
        <Route path='edit/:id' element={<ComponentTableWithTitle title='Edit Medical Center Nursing' component={<EditMedicalCenter />} />} />   
      </Route>
    </Routes>
  );
}
