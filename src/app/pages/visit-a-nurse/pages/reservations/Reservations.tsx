  ...
  return (
    <Routes>
      <Route element={<Outlet />}>
        ...
        <Route path='add' element={<ComponentTableWithTitle title={t('Add Visit A Nurse Reservasion')} component={<AddReservationPage />} />} />
        <Route path='edit/:id' element={<ComponentTableWithTitle title={t('Edit Visit A Nurse Reservation')} component={<EditReservationPage />} />} />
      </Route>
    </Routes>
  );
}
