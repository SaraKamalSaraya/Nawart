...
export default function AddAdminPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const data = res?.data?.admins.find((item: any) => item.id == id)
      setFormData({ ...data ,image:null,password:null})
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const response = await postMethod(`/admins/update/${id}`, formDataToSend)
    setLoading(false)
