  ...
  return (
    <Routes>
      <Route element={<Outlet />}>
        ...
        <Route path='add' element={<ComponentTableWithTitle title={t('Add Analysis Reservasion')} component={<AddReservationPage />} />} />
        <Route path='edit/:id' element={<ComponentTableWithTitle title={t('Edit Analysis Reservation')} component={<EditReservationPage />} />} />
      </Route>
    </Routes>
  );
}
