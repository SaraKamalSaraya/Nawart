...
export default function AddMedicalCenterAnalysisGroupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const response = await postMethod(`/medical-center-analysis-groups`, formDataToSend)
    setLoading(false)
  ...
  return (
    <Container className='mt-5 card p-8'>
      <h2>{t('Add Medical Center Analysis Group')}</h2>
