...
export default function AddAnalysisGroupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('fooooooooooo',formData)
    const response = await postMethod(`/analysis_groups`, formDataToSend)
    setLoading(false)
